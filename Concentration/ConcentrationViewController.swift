	...
	private func updateViewFromModel() {
		...
		for index in visibleCardButtons.indices {
			...
			if card.isFaceUp {
				...
				button.backgroundColor = card.isMatched ? #colorLiteral(red: 1, green: 0.5763723254, blue: 0, alpha: 0) : #colorLiteral(red: 0.5791940689, green: 0.1280144453, blue: 0.5726861358, alpha: 1)
			}
		}
